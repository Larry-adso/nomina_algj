...
if ($id_rol == '4' || $id_rol == '5') {
    ...
    if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "regm")) {
        ...
        $insertSQL = $conexion->prepare("INSERT INTO usuarios (id_us, nombre_us, apellido_us, correo_us, tel_us, pass, foto, id_rol, Codigo, id_empresa) 
                                                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
        ...
        $insertSQL->bindParam(10, $id_empresa);
        $insertSQL->execute();
